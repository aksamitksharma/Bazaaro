...
const { getNearbyVendors, getVendor, updateVendorProfile, toggleShop, toggleSellFast, getDashboard, getAnalytics, getDemandPredictions, getPriceSuggestions } = require('../controllers/vendorController');
...
router.put('/toggle-sell-fast', protect, authorize('vendor'), toggleSellFast);
